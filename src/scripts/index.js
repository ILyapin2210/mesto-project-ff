...
function submitAddCard(e) {
  ...
  cardList.prepend(createCard(cardTemplate, placeInput.value, linkInput.value, removeCard, showPopupImage, handleLike, imgPopup));
...
editProfileBtn.addEventListener('click', () => {showPopup(editProfilePopup)});
...
initialCards.forEach((place) => {
  cardList.append(createCard(cardTemplate, place.name, place.link, removeCard, showPopupImage, handleLike, imgPopup));
});
